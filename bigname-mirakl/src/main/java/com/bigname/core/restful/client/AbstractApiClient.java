...
//        ClientBuilder builder = ClientBuilder.newBuilder().withConfig(clientConfig).register(new ObjectMapperProvider(configWrapper.getObjectMapper())).register(JacksonFeature.class);
//        this.client = builder.build();
        this.client = ClientBuilder.newBuilder().withConfig(clientConfig).register(ObjectMapperProvider.class).register(JacksonFeature.class).build();
