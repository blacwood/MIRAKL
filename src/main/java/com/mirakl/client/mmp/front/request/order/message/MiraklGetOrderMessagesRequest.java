...
import com.mirakl.client.mmp.front.request.message.AbstractFrontGetMessagesRequest;

import java.util.Map;

@Unicity(includeAll = true)
public class MiraklGetOrderMessagesRequest extends AbstractFrontGetMessagesRequest {
    ...
    public boolean equals(Object o) {
        ...
        MiraklGetOrderMessagesRequest that = (MiraklGetOrderMessagesRequest) o;
