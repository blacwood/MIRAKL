...
/**
 * @deprecated Please use {@code com.mirakl.client.mmp.front.domain.shop.create.MiraklCreatedShops} or {@code com.mirakl.client.mmp.operator.domain.shop.create.MiraklCreatedShops} instead
 */
@Deprecated
