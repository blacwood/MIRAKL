...
public class MiraklUpdateShopsRequest extends AbstractMiraklApiRequest {

    private List<MiraklUpdateShop> shops;

    public MiraklUpdateShopsRequest(List<MiraklUpdateShop> shops) {
        setShops(shops);
    }

    @Override
    public MiraklApiEndpoint getEndpoint() {
        return MiraklFrontOperatorApiEndpoint.S07;
    }
    ...
    public boolean equals(Object o) {
        ...
        MiraklUpdateShopsRequest that = (MiraklUpdateShopsRequest) o;
