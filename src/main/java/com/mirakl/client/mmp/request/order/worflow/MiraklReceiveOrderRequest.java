...
public class MiraklReceiveOrderRequest extends AbstractMiraklApiRequest {

    private String orderId;

    public MiraklReceiveOrderRequest(String orderId) {
        setOrderId(orderId);
    }

    @Override
    public MiraklApiEndpoint getEndpoint() {
        return MiraklFrontOperatorApiEndpoint.OR25;
    }
    ...
    public boolean equals(Object o) {
        ...
        MiraklReceiveOrderRequest that = (MiraklReceiveOrderRequest) o;
