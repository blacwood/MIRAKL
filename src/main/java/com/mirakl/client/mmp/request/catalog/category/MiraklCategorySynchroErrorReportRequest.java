...
public class MiraklCategorySynchroErrorReportRequest extends AbstractMiraklSynchroErrorReportRequest {

    public MiraklCategorySynchroErrorReportRequest(String synchroId) {
        super(synchroId);
    }

    @Override
    public MiraklApiEndpoint getEndpoint() {
        return MiraklFrontOperatorApiEndpoint.CA03;
    }
