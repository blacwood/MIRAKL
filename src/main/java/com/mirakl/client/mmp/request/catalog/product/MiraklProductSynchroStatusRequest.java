...
public class MiraklProductSynchroStatusRequest extends AbstractMiraklSynchroStatusRequest {

    public MiraklProductSynchroStatusRequest(String synchroId) {
        super(synchroId);
    }

    @Override
    public MiraklApiEndpoint getEndpoint() {
        return MiraklFrontOperatorApiEndpoint.P22;
    }
