...
import com.mirakl.client.mmp.domain.shop.create.MiraklCreateShop;
import com.mirakl.client.request.AbstractMiraklApiRequest;

import java.util.List;

/**
 * @deprecated Please use {@code com.mirakl.client.mmp.front.request.shop.MiraklCreateShop} or {@code com.mirakl.client.mmp.operator.request.shop.MiraklCreateShop} instead
 */
@Deprecated
