...
public class MiraklCancelOrderRequest extends AbstractMiraklApiRequest {

    private String orderId;

    public MiraklCancelOrderRequest(String orderId) {
        setOrderId(orderId);
    }

    @Override
    public MiraklApiEndpoint getEndpoint() {
        return MiraklFrontOperatorApiEndpoint.OR29;
    }
    ...
    public boolean equals(Object o) {
        ...
        MiraklCancelOrderRequest that = (MiraklCancelOrderRequest) o;
